...
int rand(int start_range, int end_range)
{
    int rand_TA = 0xACE1; /* Any nonzero start state will work. */
    ...
    while(rand_TA < start_range){
        rand_TA = rand_TA + end_range - start_range;
    }
