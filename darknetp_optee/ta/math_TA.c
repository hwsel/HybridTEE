...
double ta_eee(double x)
{
    if(x>1e-3)
    {
        ...
        return 1 + x + x*x/2 + ta_pow(x,3)/6 + ta_pow(x,4)/24 + ta_pow(x,5)/120 + ta_pow(x,6)/720 + ta_pow(x,7)/5040 + ta_pow(x,8)/40320.0 + ta_pow(x,9)/362880.0 + ta_pow(x,10)/3628800.0;
}
